/* ============================================================
   partials/head.js — <head> dokumen (TEMA Kuliner)
   Merender meta description, canonical, Open Graph, Twitter Card,
   font, stylesheet, dan JSON-LD. SEMUA data SEO berasal dari core
   (ctx.seo) sehingga tema TIDAK menulis ulang logika SEO — cukup
   merendernya. Inilah yang membuat tema ini otomatis SEO-ready
   selama memanggil partial ini (skema @graph ditangani inti).
   ============================================================ */
...
module.exports = function head(ctx) {
  ...
  return '<head>\n' +
    ...
    '  <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@500;600;700;800&family=Plus+Jakarta+Sans:wght@400;500;600;700&family=Inter:wght@400;500;600&display=swap" rel="stylesheet">\n' +
    '  <link rel="stylesheet" href="' + attr(U.url("/theme/style.css")) + '">' + themeVars + jsonLd +
    ((ctx.plugins && ctx.plugins.headExtra) ? ctx.plugins.headExtra(ctx) : "") + "\n" +
    "</head>";
};
